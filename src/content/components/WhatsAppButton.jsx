...
export default function WhatsAppButton({ whatsapp }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 hover:rotate-12 ${
